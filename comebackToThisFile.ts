// come back to these tests and refactor them to use the new run() and executeCommand() functions
// they've been removed temporarily to get focus on implenting newer functionality
// the run() function invokes all of the other functions including: execute, move, turn, ect.
